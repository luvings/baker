...
let g:formatdef_allman = '"indent -npro -kr -i8 -ts8 -sob -l120 -ss -ncs -cp1"'
"let g:formatdef_allman = '"astyle --style=kr --pad-oper --pad-header --align-pointer=name --indent=tab=8 --break-after-logical --break-blocks=all --unpad-paren --indent-col1-comments --attach-return-type-decl --attach-return-type -n --max-code-length=120 --recursive"'
...
noremap <leader>R :!ctags-exuberant -R -f .tags<CR>
